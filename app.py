...
from PDF import PDF
from collections import OrderedDict #for the color paltte
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\clear_left.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        font = QtGui.QFont()
        font.setPointSize(20)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\p.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        font = QtGui.QFont()
        font.setPointSize(20)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\t.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.graphicsView_4 = GraphicsLayoutWidget(self.centralwidget)
        font = QtGui.QFont()
        font.setStrikeOut(False)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        ...
        self.graphicsView_5 = GraphicsLayoutWidget(self.centralwidget)
        font = QtGui.QFont()
        font.setStrikeOut(False)
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        ...
        self.graphicsView_6 = GraphicsLayoutWidget(self.centralwidget)
        ...
        self.zz1.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\zz.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zz1.setIcon(icon3)
        self.zz1.setObjectName("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\zz1")
        self.horizontalLayout_5.addWidget(self.zz1)
        self.z1 = QtWidgets.QPushButton(self.widget)
        self.z1.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\z.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.z1.setIcon(icon4)
        self.z1.setObjectName("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\z1")
        self.horizontalLayout_5.addWidget(self.z1)
        self.horizontalLayout_8.addLayout(self.horizontalLayout_5)
        self.print1 = QtWidgets.QPushButton(self.widget)
        self.print1.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:\\xampp\\mysql\\bin\\task1 signal veiwer\\print.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
#>>>>>>>>>>>>>>>>>>>>  ########### printing
 ...
 #>>>>>>>>>>>>>>       ######3 loading files
    ...
    # Limit panning/zooming to the spectrogram
        p1.setLimits(xMin=0, xMax=t[-1], yMin=0, yMax=60)
    ...
    # If you include the units, Pyqtgraph automatically scales the axis and adjusts the SI prefix (in this case kHz)
        ...
        hist.gradient.restoreState(self.Gradients["magma"])
...
###########################################################################3
    ...
    def draw_spectrogram_of_channel_2(self):
        ...
        fs = 1 /(self.time_of_signal_2[1] - self.time_of_signal_2[0])
        array_of_sample = np.array(self.amplitude_of_signal_2)
        f, t, Sxx = signal.spectrogram(array_of_sample, fs)
    ...
    # If you include the units, Pyqtgraph automatically scales the axis and adjusts the SI prefix (in this case kHz)
        ...
        hist.gradient.restoreState(self.Gradients["spectrum"])
    ...
    def draw_spectrogram_of_channel_3(self):
        ...
        fs = 1 /(self.time_of_signal_3[1] - self.time_of_signal_3[0])
        array_of_sample = np.array(self.amplitude_of_signal_3)
        f, t, Sxx = signal.spectrogram(array_of_sample, fs)
    ...
    # If you include the units, Pyqtgraph automatically scales the axis and adjusts the SI prefix (in this case kHz)
        ...
        hist.gradient.restoreState(self.Gradients["yellowy"])
